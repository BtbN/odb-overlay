...
DESCRIPTION="Codesynthesis' ODB runtime for accessing a Microsoft SQL database"
...
IUSE="static-libs threads doc examples"

DEPEND="=dev-db/libodb-${MY_V}*[static-libs?,threads=]
		 dev-db/unixODBC[static-libs?,iconv-char-enc-utf8(+),iconv-ucode-enc-utf16(+)]"

RDEPEND="${DEPEND}
		 dev-db/sqlncli[doc?,examples?]"
